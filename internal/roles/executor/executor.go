...
// Serper.dev is used automatically when SERPER_API_KEY is set.
const searchToolEntry = `8. search — web search (DuckDuckGo by default; Serper.dev when SERPER_API_KEY is set). Input: {"action":"tool","tool":"search","query":"..."}`
